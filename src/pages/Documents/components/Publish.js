                ...
                {initialData.isPublished ? (
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                            <input className="flex-1 px-2 text-xs border rounded-l-md h-8" value={url} disabled />
                            <Button
                                variant="primary"
                                onClick={onCopy}
                                disabled={copied}
                                className={'h-8 border rounded-l-none'}
                            >
                    ...
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <Button variant="primary" onClick={onPublish} className={'w-full text-xs'}>
                            Publish
                        </Button>
                    </div>
                )}
